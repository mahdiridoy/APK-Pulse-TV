...
import com.pulsestream.app.databinding.MainSettingsBinding
...
import com.pulsestream.app.ui.home.HomeFragment.Companion.errorProfilePic
...
import com.pulsestream.app.ui.watchtogether.WatchTogetherDialog
import com.pulsestream.app.utils.DataStoreHelper
import com.pulsestream.app.utils.GitInfo.currentCommitHash
...
class SettingsFragment : BaseFragment<MainSettingsBinding>(
    ...
    override fun onBindingCreated(binding: MainSettingsBinding) {
        ...
        binding.apply {
            ...
            // Community � direct settings option
            settingsCommunity.apply {
                setOnClickListener {
                    navigate(R.id.action_navigation_global_to_navigation_settings_community)
                }
                if (isLayout(TV)) {
                    isFocusable = true
                    isFocusableInTouchMode = true
            ...
            settingsWatchTogether.setOnClickListener {
                WatchTogetherDialog.show(requireContext())
            }
            if (isLayout(TV)) {
                settingsWatchTogether.isFocusable = true
                settingsWatchTogether.isFocusableInTouchMode = true
            }
