package com.pulsestream.app.ui.result
...
import com.pulsestream.app.CloudStreamApp.Companion.context
import com.pulsestream.app.CloudStreamApp.Companion.setKey
import com.pulsestream.app.CommonActivity.activity
import com.pulsestream.app.CommonActivity.getCastSession
...
import com.pulsestream.app.actions.AlwaysAskAction
...
import com.pulsestream.app.syncproviders.AccountManager.Companion.secondsToReadable
import com.pulsestream.app.syncproviders.SyncAPI
import com.pulsestream.app.syncproviders.providers.Kitsu
...
import com.pulsestream.app.ui.player.LOADTYPE_ALL
import com.pulsestream.app.ui.player.LOADTYPE_CHROMECAST
import com.pulsestream.app.ui.player.LOADTYPE_INAPP
...
import com.pulsestream.app.ui.result.EpisodeAdapter.Companion.getPlayerAction
import com.pulsestream.app.ui.watchtogether.WatchTogetherManager
import com.pulsestream.app.utils.AppContextUtils.getNameFull
import com.pulsestream.app.utils.AppContextUtils.isConnectedToChromecast
...
import com.pulsestream.app.utils.CastHelper.startCast
import com.lagradost.cloudstream3.utils.Coroutines.ioSafe
import com.lagradost.cloudstream3.utils.Coroutines.ioWork
import com.lagradost.cloudstream3.utils.Coroutines.ioWorkSafe
import com.lagradost.cloudstream3.utils.Coroutines.main
import com.pulsestream.app.utils.DOWNLOAD_HEADER_CACHE
import com.pulsestream.app.utils.DataStore
import com.pulsestream.app.utils.DataStore.editor
...
import com.pulsestream.app.utils.DataStoreHelper.deleteBookmarkedData
import com.pulsestream.app.utils.DataStoreHelper.getAllBookmarkedData
...
import com.pulsestream.app.utils.DataStoreHelper.getDub
import com.pulsestream.app.utils.DataStoreHelper.getFavoritesData
import com.pulsestream.app.utils.DataStoreHelper.getLastWatched
import com.pulsestream.app.utils.DataStoreHelper.getResultEpisode
import com.pulsestream.app.utils.DataStoreHelper.getResultSeason
import com.pulsestream.app.utils.DataStoreHelper.getResultWatchState
import com.pulsestream.app.utils.DataStoreHelper.getSubscribedData
import com.pulsestream.app.utils.DataStoreHelper.getVideoWatchState
import com.pulsestream.app.utils.DataStoreHelper.getViewPos
import com.pulsestream.app.utils.DataStoreHelper.removeFavoritesData
import com.pulsestream.app.utils.DataStoreHelper.removeSubscribedData
import com.pulsestream.app.utils.DataStoreHelper.setBookmarkedData
import com.pulsestream.app.utils.DataStoreHelper.setDub
import com.pulsestream.app.utils.DataStoreHelper.setFavoritesData
import com.pulsestream.app.utils.DataStoreHelper.setResultEpisode
import com.pulsestream.app.utils.DataStoreHelper.setResultSeason
import com.pulsestream.app.utils.DataStoreHelper.setResultWatchState
import com.pulsestream.app.utils.DataStoreHelper.setSubscribedData
import com.pulsestream.app.utils.DataStoreHelper.setVideoWatchState
import com.pulsestream.app.utils.DataStoreHelper.updateSubscribedData
import com.pulsestream.app.utils.Editor
import com.lagradost.cloudstream3.utils.ExtractorLink
import com.lagradost.cloudstream3.utils.ExtractorLinkType
import com.pulsestream.app.utils.FillerEpisodeCheck
import com.lagradost.cloudstream3.utils.INFER_TYPE
import com.lagradost.cloudstream3.utils.Qualities
import com.pulsestream.app.utils.UIHelper.navigate
import com.pulsestream.app.utils.UiText
import com.pulsestream.app.utils.VIDEO_WATCH_STATE
...
class ResultViewModel2 : ViewModel() {
    ...
    private suspend fun CoroutineScope.loadLinks(
        ...
        return LinkLoadingResult(
            ...
            generator?.videos ?: listOf(result),
            currentResponse
        )
    }
                ...
                START_ACTION_LOAD_EP -> {
                    ...
                    val episode =
                        autostart.id?.let { id -> all.firstOrNull { it.id == id } }
                            ...
                            // Fall back to the first playable episode when the requested one
                            // cannot be resolved (e.g. a movie/trailer that carries no useful
                            // episode id). Otherwise the viewer would land on the result page
                            // and have to pick something manually.
                            ?: currentEpisodes[currentIndex]?.firstOrNull()
                            ?: all.firstOrNull()
                            ?: return@launchSafe
                    // When following a Watch Together host, always open the internal player so
                    // a viewer preference for an external player / "always ask" doesn't pop up
                    // a manual selection dialog and break the automatic synchronization.
                    val action = if (WatchTogetherManager.role == WatchTogetherManager.Role.VIEWER) {
                        ACTION_PLAY_EPISODE_IN_PLAYER
                    } else {
                        getPlayerAction(activity)
                    }
