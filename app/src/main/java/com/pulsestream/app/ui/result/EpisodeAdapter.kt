...
import com.pulsestream.app.databinding.ResultEpisodeBinding
import com.pulsestream.app.databinding.ResultEpisodeLargeBinding
...
import com.pulsestream.app.ui.newSharedPool
...
class EpisodeAdapter(
    ...
    companion object {
        ...
        fun getPlayerAction(context: Context): Int {
            ...
            // An explicitly chosen player wins.
            VideoClickActionHolder.uniqueIdToId(playerPref)?.let { return it }

            // Auto-selected default player: Play Mirror.
            return VideoClickActionHolder.uniqueIdToId(PlayMirrorAction().uniqueId())
