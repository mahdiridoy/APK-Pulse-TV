...
import com.pulsestream.app.databinding.FragmentPluginDetailsBinding
import com.pulsestream.app.plugins.PluginManager
import com.pulsestream.app.plugins.VotingApi.canVote
import com.pulsestream.app.plugins.VotingApi.getVotes
import com.pulsestream.app.plugins.VotingApi.hasVoted
import com.pulsestream.app.plugins.VotingApi.vote
import com.pulsestream.app.R
import com.pulsestream.app.ui.BaseBottomSheetDialogFragment
    ...
    override fun onBindingCreated(binding: FragmentPluginDetailsBinding) {
        ...
        binding.apply {
            ...
            if (data.isDownloaded) {
                ...
                val plugin =
                    (PluginManager.urlPlugins[metadata.url] ?: PluginManager.plugins[metadata.url]) as? com.pulsestream.app.plugins.Plugin
