...
abstract class BasePreferenceFragmentCompat() : PreferenceFragmentCompat() {
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Without an initial focus target the D-pad has nowhere to move from, so remote
        // navigation appears completely dead on this screen until touch is used first.
