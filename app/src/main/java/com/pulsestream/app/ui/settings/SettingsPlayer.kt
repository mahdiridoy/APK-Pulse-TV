...
import com.pulsestream.app.ui.settings.SettingsFragment.Companion.getFolderSize
...
import com.pulsestream.app.ui.settings.SettingsFragment.Companion.hidePrefs
...
import com.pulsestream.app.ui.subtitles.ChromecastSubtitlesFragment
...
class SettingsPlayer : BasePreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        getPref(R.string.player_default_key)?.setOnPreferenceClickListener {
            ...
            val stored = settingsManager.getString(getString(R.string.player_default_key), "") ?: ""
            // Auto-select Play Mirror when no player has been configured yet.
            val current = stored.takeIf { it.isNotBlank() } ?: PlayMirrorAction().uniqueId()
            activity?.showBottomDialog(
                prefNames.toList(),
