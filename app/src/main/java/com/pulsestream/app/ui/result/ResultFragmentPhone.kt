...
import com.pulsestream.app.databinding.FragmentResultBinding
import com.pulsestream.app.databinding.FragmentResultSwipeBinding
import com.pulsestream.app.databinding.ResultRecommendationsBinding
import com.pulsestream.app.databinding.ResultSyncBinding
import com.pulsestream.app.databinding.TrailerCustomLayoutBinding
...
import com.pulsestream.app.ui.download.DOWNLOAD_ACTION_DOWNLOAD
import com.pulsestream.app.ui.download.DOWNLOAD_ACTION_LONG_CLICK
import com.pulsestream.app.ui.download.DownloadButtonSetup
import com.pulsestream.app.ui.player.CS3IPlayer
import com.pulsestream.app.ui.player.CSPlayerEvent
import com.pulsestream.app.ui.player.IPlayer
import com.pulsestream.app.ui.player.PlayerView
import com.pulsestream.app.ui.player.source_priority.QualityProfileDialog
import com.pulsestream.app.ui.quicksearch.QuickSearchFragment
import com.pulsestream.app.ui.result.ResultFragment.bindLogo
import com.pulsestream.app.ui.result.ResultFragment.getStoredData
import com.pulsestream.app.ui.result.ResultFragment.updateUIEvent
import com.pulsestream.app.ui.search.SearchAdapter
import com.pulsestream.app.ui.search.SearchHelper
import com.pulsestream.app.ui.setRecycledViewPool
import com.pulsestream.app.ui.settings.SettingsGeneral.Companion.pickDownloadPath
import com.pulsestream.app.ui.settings.utils.getChooseFolderLauncher
...
import com.pulsestream.app.utils.BatteryOptimizationChecker.openBatteryOptimizationSettings
...
import com.pulsestream.app.utils.SingleSelectionHelper.showBottomDialogInstant
...
import com.pulsestream.app.utils.UIHelper.populateChips
import com.pulsestream.app.utils.UIHelper.popupMenuNoIconsAndNoStringRes
import com.pulsestream.app.utils.UIHelper.setListViewHeightBasedOnItems
...
import com.pulsestream.app.utils.getImageFromDrawable
            ...
            resultSubscribe.setOnClickListener {
                viewModel.toggleSubscriptionStatus(context) { newStatus: Boolean? ->
                    ...
                    val name = (viewModel.page.value as? Resource.Success)?.value?.title
                        ?: com.pulsestream.app.utils.txt(R.string.no_data)
                            .asStringNull(context) ?: ""
                    showToast(
                        com.pulsestream.app.utils.txt(message, name),
                        Toast.LENGTH_SHORT
                    )
                }
        ...
        observe(viewModel.page) { data ->
            ...
            resultBinding?.apply {
                    ...
                    binding.apply {
                        ...
                        resultShare.setOnClickListener {
                            try {
                                ...
                                // PulseStream: share the direct csshare URI
                                // (no external redirect needed � works when the recipient has PulseStream installed)
                                i.type = "text/plain"
                                i.putExtra(Intent.EXTRA_SUBJECT, d.title)
                                i.putExtra(Intent.EXTRA_TEXT, encodedUri)
                ...
                resultTitle.setOnLongClickListener {
                    clipboardHelper(
                        com.pulsestream.app.utils.txt(R.string.title),
                        resultTitle.text
                    )
                    true
                }
