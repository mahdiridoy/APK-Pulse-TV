...
import com.pulsestream.app.CommonActivity.keyEventListener
...
import com.pulsestream.app.databinding.SpeedDialogBinding
import com.pulsestream.app.databinding.SubtitleOffsetBinding
import com.lagradost.cloudstream3.mvvm.logError
import com.pulsestream.app.ui.player.GeneratorPlayer.Companion.subsProvidersIsActive
...
import com.pulsestream.app.utils.AppContextUtils.isUsingMobileData
import com.pulsestream.app.utils.AppContextUtils.shouldShowPlayerMetadata
...
open class FullScreenPlayer : AbstractPlayerFragment<FragmentPlayerBinding>(
    ...
    private fun handleKeyEvent(event: KeyEvent, hasNavigated: Boolean): Boolean {
        ...
        when (keyCode) {
            ...
            // netflix capture back and hide ~monke
            // Removed due to inconsistent behavior on A36 vs A22
