...
import com.pulsestream.app.ui.player.SubtitleOrigin
...
import com.pulsestream.app.utils.serializers.UriSerializer
...
class CloudStreamPackage : OpenInAppAction(
    ...
    packageName = BuildConfig.APPLICATION_ID, //"com.pulsestream.app" or "com.pulsestream.app.prerelease"
    intentClass = "com.pulsestream.app.ui.player.DownloadedPlayerActivity"
) {
