...
import com.pulsestream.app.ui.WebviewFragment
import com.pulsestream.app.ui.player.SubtitleData
import com.pulsestream.app.ui.result.ResultFragment
import com.pulsestream.app.ui.settings.Globals
import com.pulsestream.app.ui.settings.extensions.PluginsFragment
...
import com.pulsestream.app.utils.FillerEpisodeCheck.toClassDir
...
//        hashSet.add("en") // def is only en
    ...
    fun Context.filterProviderByPreferredMedia(hasHomePageIsRequired: Boolean = true): List<MainAPI> {
        ...
        // java.lang.ClassCastException: com.pulsestream.app.TvType cannot be cast to com.pulsestream.app.TvType
    ...
    /* @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            imports = ["com.pulsestream.app.splitUrlParameters"],
        ),
